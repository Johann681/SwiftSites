...
export default function AiDashboard() {
  ...
  const generatePlan = async (payload?: Brief) => {
    ...
    try {
      ...
      const text = [
        ...
        } website focused on growth and conversions.`,
  ...
  const featureSuggestions = (d: Brief) => {
    ...
    if (d.style?.toLowerCase().includes("minimal"))
      f.push("Large hero section & clean gallery");
        ...
        >
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-gray-600 max-w-xl">
              Describe your brand and budget — AI will propose a custom website
              plan you can instantly send to your team.
            </p>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-24 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InfoCard
              title="Inspiration"
              desc="Examples tailored to your chosen style will appear here. Use them to show clients what’s possible."
            />
            <InfoCard
              title="Tips"
              desc={
          ...
          <InfoCard
            ...
            desc={
              result ? (
                ...
                "Generate a plan to see suggestions here."
              )
            }
          />
                ...
                <button
                  onClick={() => {
                    const subject = encodeURIComponent(
                      `Project: ${brief.companyName || "New Lead"}`
                    );
